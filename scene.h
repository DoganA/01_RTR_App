...
protected:
    ...
    std::map<QString, std::shared_ptr<PhongMaterial>> mPhongMaterials_;
    std::map<QString, std::shared_ptr<ToonMaterial>> mToonMaterials_;
    std::map<QString, std::shared_ptr<PointMaterial>> mPointMaterials_;
